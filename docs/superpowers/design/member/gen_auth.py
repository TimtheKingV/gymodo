...
# ========================================================== MemberKeinStudio
# Der wichtigste der fuenf: was ein frisch registriertes Mitglied sieht.
# Keine Tab-Leiste -- es gibt nichts, wohin man wechseln koennte. Nur das
# Code-Feld und der eine Satz, der die Lage erklaert.
kein_studio = spacer_top() + kopf_marke()
kein_studio += titel('Noch kein Studio', 'gymodo gehört zu einem Studio. Gib den Code ein, den du dort bekommst.', top=40)
kein_studio += feld('Studio-Code', '<span class="num" style="font-size: 18px; letter-spacing: .08em;">KWNORD-7F2X</span>', monospace=True)
kein_studio += fuellen()
kein_studio += ("""
  <div style="flex: none; padding: 0 28px 20px; display: flex; flex-direction: column; gap: 12px;">
    <div style="%s">Studio beitreten</div>
    <div style="%s text-align: center;">Du hast keinen Code? Frag an der Theke.</div>
  </div>
""" % (PRIMARY, NOTE_FAINT))
