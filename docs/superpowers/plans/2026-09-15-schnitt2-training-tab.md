...
- **Offline-Fotos.** Kein Medien-Cache über den Screen hinaus. Ohne Netz bleibt die Liste ohne Bilder, wie der Gerätescreen offline ohne Foto bleibt (Kernflow-Spec §8.4).
